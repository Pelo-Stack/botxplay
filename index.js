...
const Facebook = 'https://www.facebook.com/alif.m.p.54'; 
const telegram = 'BELUM ADA TELEGRAM'; 
const kapanbotaktif = 'KETIKA ADA TULISAN BOT ON✅ DI INFONYA'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Yt: AnggorGAMEP')
...
conn.sendMessage(id, menu.menu(id, BotName, corohelp, tampilTanggal, tampilWaktu, Facebook, telegram, youtube, kapanbotaktif) ,MessageType.text);
}
else if (text == ';quran'){
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donasi.donasi(id, BotName, corohelp, tampilTanggal, tampilWaktu, Facebook, telegram, youtube, kapanbotaktif) ,MessageType.text);
}
else if (text == ';info'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, BotName, corohelp, tampilTanggal, tampilWaktu, Facebook, telegram, youtube, kapanbotaktif) ,MessageType.text);
}
else if (text == ';pict'){
